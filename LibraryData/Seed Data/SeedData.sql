...
VALUES 
('/images/branches/1.png', '1379 Paterson Plank Rd', 'Secaucus Branch', '(201) 330-2083', '1935-05-13', 'With its humble beginnings in 1935 in Town Hall’s attic, The Secaucus Public Library has grown to play an active role in a vibrant and civically engaged community; a place where people celebrate words, ideas, and community every day.Located on the main street of Paterson Plank Road, the library is easily accessible to Secaucus residents and any visitors. A world-class collection, expert staff, and thousands of engaging programs each year mean that everyone can find something at the library. For more than 78 years, the Secaucus Public Library has been impacting the lives of Secaucus residents.'),
